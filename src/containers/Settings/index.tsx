...
import { MdOutlineSettings as GeneralIcon, MdOutlineSecurity as AuthIcon } from "react-icons/md";
...
const settingMenus = [
    ...
    },
    {
        icon: <AuthIcon />,
        name: "authentication",
        displayText: fixtures.settingsStrings["settings-menu.authentication.buttontext"],
        goto: "authentication",
    },
];
