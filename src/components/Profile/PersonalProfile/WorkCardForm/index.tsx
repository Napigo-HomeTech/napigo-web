      ...
      >
        <GridItem colSpan={2}>
          <TextField
            ...
            placeholder={
              fixtures.profileStrings["work.job-title.input.placeholder"]
            }
          />
        </GridItem>
        <GridItem colSpan={2}>
          <FormControl>
            <FormLabel>
              {fixtures.profileStrings["work.employment-type.select.label"]}
            </FormLabel>
            <Select
        ...
        <GridItem colSpan={2}>
          <FormControl>
            <FormLabel>
              {fixtures.profileStrings["work.organization.select.label"]}
            </FormLabel>
