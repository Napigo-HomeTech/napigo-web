const data = {
    "settings-menu.general.buttontext": "General",
    "settings-menu.authentication.buttontext": "Authentication",
    ...
    "authentication.passwordform.submit.buttontext": "Confirm",
    "authentication.passwordform.cancel.buttontext": "Cancel",
    "authentication.mobileform.heading": "Mobile Number",
    "authentication.mobileform.verified.description": `Your phone number can be used as backup when losing your
  password or forgotten your login email address. It can be used
  for MFA, please refer to the MFA section on setup.`,
    "authentication.mobileform.notverified.description": `Provide us with your mobile number to allow mobile
  authentication for your login method or you can use for backup
  in case you couldnt logon to your email address`,
    "authentication.mobileform.verified-alert.title": "Verified!",
    "authentication.mobileform.verified-alert.description": `Your Phone number have been added, you can now setup MFA for
